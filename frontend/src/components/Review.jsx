...
const Review = () => {
  ...
  useEffect(() => {
    const fetchReviews = async () => {
      try {
        const response = await axios.get('https://eduxcel-api-14april.onrender.com/reviews');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://eduxcel-api-14april.onrender.com/reviews', {
        username,
        comment,
      });
